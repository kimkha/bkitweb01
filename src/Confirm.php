<?php
    ...
    {
        var_export($_POST);
		$skillString = array('','Chưa biết', 'Căn bản', 'Khá', 'Tốt');
...
<table width="1234" border="1">
  <tr>
    <td width="538" height="389"><fieldset>
      ...
      <p><?php echo $_POST['txtExpectation']; ?> </p>
      <p><strong>Sở Thích:</strong></p>
      <p>
        <?php echo $_POST['txtHobby']; ?>
      </p>
      <table width="400" border="1" align="left">
        <tr>
          ...
          <td width="267"><?php echo $_POST['txtName']; ?></td>
        </tr>
        <tr>
          <td><div align="right">Ngày Sinh:</div></td>
          <td><?php echo $_POST['txtBirthday']; ?></td>
        </tr>
        <tr>
          <td><div align="right">Giới Tính:</div></td>
          <td><?php echo $_POST['radSex']; ?></td>
        </tr>
        <tr>
          <td><div align="right">Sinh Viên Khóa:</div></td>
          <td><?php echo $_POST['lstCourse']; ?></td>
        </tr>
        <tr>
          <td><div align="right">Địa Chỉ Liên Lạc</div></td>
          <td><?php echo $_POST['txtAddress']; ?></td>
        </tr>
        <tr>
      ...
      <p>
        ...
        <input type="submit" name="btnDelete" id="btnDelete" value="Confirm" />
      </p>
    </fieldset></td>
        ...
        <div id="skill1">
          <table width="400" border="1">
            <tr>
              ...
              <td width="48"><?php echo $skillString[(int)$_POST['PhotoshopSkill']]; ?></td>
            </tr>
            <tr>
              <td><div align="right">HTML/CSS</div></td>
              <td><?php echo $skillString[(int)$_POST['HTMLSkill']]; ?></td>
            </tr>
            <tr>
              <td><div align="right">JavaScript</div></td>
              <td><?php echo $skillString[(int)$_POST['JVScriptSkill']]; ?></td>
            </tr>
            <tr>
              <td><div align="right">Flash, Sliverlight, Air</div></td>
              <td><?php echo $skillString[(int)$_POST['FlashSkill']]; ?></td>
            </tr>
          </table>
        </div>
        <p>&nbsp;</p>
      ...
      <div id="skill2">
        <table width="400" border="1">
          <tr>
            ...
            <td width="219"><?php echo $skillString[(int)$_POST['PHPSkill']]; ?></td>
          </tr>
          <tr>
            <td><div align="right">ASP.NET</div></td>
            <td><?php echo $skillString[(int)$_POST['ASPSkill']]; ?></td>
          </tr>
          <tr>
            <td><div align="right">JSP</div></td>
            <td><?php echo $skillString[(int)$_POST['JSPSkill']]; ?></td>
          </tr>
          <tr>
            <td><div align="right">Google Apps Engine</div></td>
            <td><?php echo $skillString[(int)$_POST['GAESkill']]; ?></td>
          </tr>
          <tr>
            <td><div align="right">MySQL</div></td>
            <td><?php echo $skillString[(int)$_POST['MySQLSkill']]; ?></td>
          </tr>
          <tr>
            <td><div align="right">MS SQL Server</div></td>
            <td><?php echo $skillString[(int)$_POST['MSSQLSkill']]; ?></td>
          </tr>
        </table>
      </div>
    </fieldset>  
